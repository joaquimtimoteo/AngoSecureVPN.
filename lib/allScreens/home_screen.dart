...
import 'package:vpn_basic_project/allScreens/connected_network_ip_info_screen.dart';
      ...
      child: Semantics(
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            padding: EdgeInsets.symmetric(horizontal: sizeScreen.width * .050),
            height: 62,
            child: Row(
              children: [
                Icon(
      ...
      children: [
        ...
        Container(
          margin: EdgeInsets.only(
              top: sizeScreen.height * .015, bottom: sizeScreen.height * .02),
